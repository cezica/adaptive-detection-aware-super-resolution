...
class Config:
    ...
    save_path: str = "srcnn_x4_adaptive_3region_thr1035.pth"
    seed: int = 42
...
# -------------------------
def adaptive_3region_loss(sr: torch.Tensor, hr: torch.Tensor):
    """
    smooth  -> MSE
    texture -> Charbonnier
    edge    -> L1
...
def train_one_epoch(model, loader, optim, device):
    ...
    for bic, hr in loader:
        ...
        total, loss_smooth, loss_texture, loss_edge, *_ = adaptive_3region_loss(sr, hr)
